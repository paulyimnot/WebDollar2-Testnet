        ...
        <CyberCard title="SEND WD2" className="border-accent/20">
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <Input value={recipient} onChange={(e) => setRecipient(e.target.value)} className="!bg-black/70 !border-primary/50 font-mono py-8 text-lg text-white placeholder:text-muted-foreground focus:!bg-black/90" placeholder="Enter Address or Alias..." />
            </div>
            <div className="space-y-4">
              <label className="text-sm font-mono text-primary font-bold uppercase tracking-wider">AMOUNT (WD2)</label>
              <Input type="number" value={amount} onChange={(e) => setAmount(e.target.value)} className="!bg-black/70 !border-primary/50 font-mono text-3xl py-10 text-accent font-black max-w-[280px] focus:!bg-black/90" placeholder="0.00" />
            </div>
            <div className="space-y-2">
              <label className="text-xs font-mono text-primary/70 uppercase tracking-widest flex items-center gap-2">PASSWORD</label>
              <Input type="password" placeholder="Confirm your password" value={txPassword} onChange={(e) => setTxPassword(e.target.value)} className="!bg-black/70 !border-primary/50 font-mono py-6 text-white placeholder:text-muted-foreground focus:!bg-black/90" />
            </div>
